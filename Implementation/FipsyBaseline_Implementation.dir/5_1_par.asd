...
GLOBAL_PRIMARY_1_SIGNALNAME = vga_inst/led_count_6;
GLOBAL_PRIMARY_1_DRIVERTYPE = SLICE;
GLOBAL_PRIMARY_1_LOADNUM = 30;
; Global primary clock #2
GLOBAL_PRIMARY_2_SIGNALNAME = vga_inst/line_cycle;
GLOBAL_PRIMARY_2_DRIVERTYPE = SLICE;
GLOBAL_PRIMARY_2_LOADNUM = 22;
; Global primary clock #3
GLOBAL_PRIMARY_3_SIGNALNAME = vga_inst/led_count_5;
