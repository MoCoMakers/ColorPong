...
defparam OSCH_inst.NOM_FREQ = "38";   // Must be one of the allowed frequencies (2.08MHz default)	//38 for pllv2, 133 for pll
...
pllv2 Clk_25MHz_inst (.CLKI(INTERNAL_OSC), .CLKOP(clk));
